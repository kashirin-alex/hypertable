...
class ColumnPredicate : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ColumnPredicate() noexcept;
...
class ResultAsArrays : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ResultAsArrays() noexcept;
  bool is_empty;
  int64_t id;
  bool is_scan;
  bool is_error;
...
class ResultSerialized : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ResultSerialized() noexcept;
  bool is_empty;
  int64_t id;
  bool is_scan;
  bool is_error;
...
class NamespaceListing : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~NamespaceListing() noexcept;
  std::string name;
  bool is_namespace;
...
class ColumnFamilyOptions : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ColumnFamilyOptions() noexcept;
...
class ColumnFamilySpec : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~ColumnFamilySpec() noexcept;
  std::string name;
...
class AccessGroupOptions : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~AccessGroupOptions() noexcept;
  int16_t replication;
  int32_t blocksize;
...
class AccessGroupSpec : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~AccessGroupSpec() noexcept;
  std::string name;
  int64_t generation;
