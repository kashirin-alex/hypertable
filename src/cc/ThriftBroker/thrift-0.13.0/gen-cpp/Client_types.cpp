...
std::string to_string(const ColumnPredicateOperation::type& val) {
  std::map<int, const char*>::const_iterator it = _ColumnPredicateOperation_VALUES_TO_NAMES.find(val);
  if (it != _ColumnPredicateOperation_VALUES_TO_NAMES.end()) {
...
std::string to_string(const KeyFlag::type& val) {
  std::map<int, const char*>::const_iterator it = _KeyFlag_VALUES_TO_NAMES.find(val);
  if (it != _KeyFlag_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
std::string to_string(const MutatorFlag::type& val) {
  std::map<int, const char*>::const_iterator it = _MutatorFlag_VALUES_TO_NAMES.find(val);
  if (it != _MutatorFlag_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
RowInterval::~RowInterval() noexcept {
}
...
CellInterval::~CellInterval() noexcept {
}
...
ColumnPredicate::~ColumnPredicate() noexcept {
}
...
MutateSpec::~MutateSpec() noexcept {
}
...
ResultAsArrays::~ResultAsArrays() noexcept {
}
...
ResultSerialized::~ResultSerialized() noexcept {
}
...
NamespaceListing::~NamespaceListing() noexcept {
}
...
TableSplit::~TableSplit() noexcept {
}
...
ColumnFamilyOptions::~ColumnFamilyOptions() noexcept {
}
...
ColumnFamilySpec::~ColumnFamilySpec() noexcept {
}
...
AccessGroupOptions::~AccessGroupOptions() noexcept {
}
...
AccessGroupSpec::~AccessGroupSpec() noexcept {
}
